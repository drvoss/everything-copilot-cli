...
- Use fresh target directories under `C:\copilot-lab`.
...
1. Remove any old tutorial directories:
   ...
   ```powershell
   Remove-Item C:\copilot-lab\skills-lab-template -Recurse -Force -ErrorAction SilentlyContinue
...
4. In `C:\copilot-lab\skills-lab-template`, run:
